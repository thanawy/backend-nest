...
export class InitialMigration implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "question_tag" ("question_id" uuid NOT NULL, "tag_id" uuid NOT NULL, CONSTRAINT "PK_1b280c31469075075860df9d6b0" PRIMARY KEY ("question_id", "tag_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "question_collection" ("question_id" uuid NOT NULL, "collection_id" uuid NOT NULL, CONSTRAINT "PK_b9947597d9987678a100e0aa524" PRIMARY KEY ("question_id", "collection_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5eb835210f7d4e610f1eeb3b31" ON "question_collection" ("question_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_6f3f31e2ffe2b550436d974047" ON "question_collection" ("collection_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "program_subject" ("program_id" uuid NOT NULL, "subject_id" uuid NOT NULL, CONSTRAINT "PK_0a4de9c70e3c87a9e561dc94127" PRIMARY KEY ("program_id", "subject_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_71d5a245ea8a708c1cc303bf0a" ON "program_subject" ("program_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3321e25af675736554263e6260" ON "program_subject" ("subject_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "chapter" ADD CONSTRAINT "FK_cac7772512e16a8cbbeea5a91ca" FOREIGN KEY ("subject_id") REFERENCES "subject"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_ab02fb05fe2e9b1e6ebaead78ed" FOREIGN KEY ("program_id") REFERENCES "program"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ADD CONSTRAINT "FK_ec4e57f4138e339fb111948a16f" FOREIGN KEY ("subscription_id") REFERENCES "subscription"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "question_tag" ADD CONSTRAINT "FK_c1908d5b6571f3154cda55a1346" FOREIGN KEY ("question_id") REFERENCES "question"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_tag" ADD CONSTRAINT "FK_bd2136aacc58fb57e8ee17b6845" FOREIGN KEY ("tag_id") REFERENCES "tag"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_collection" ADD CONSTRAINT "FK_5eb835210f7d4e610f1eeb3b31b" FOREIGN KEY ("question_id") REFERENCES "question"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_collection" ADD CONSTRAINT "FK_6f3f31e2ffe2b550436d9740476" FOREIGN KEY ("collection_id") REFERENCES "collection"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "program_subject" ADD CONSTRAINT "FK_71d5a245ea8a708c1cc303bf0a4" FOREIGN KEY ("program_id") REFERENCES "program"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "program_subject" ADD CONSTRAINT "FK_3321e25af675736554263e6260f" FOREIGN KEY ("subject_id") REFERENCES "subject"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "program_subject" DROP CONSTRAINT "FK_3321e25af675736554263e6260f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "program_subject" DROP CONSTRAINT "FK_71d5a245ea8a708c1cc303bf0a4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_collection" DROP CONSTRAINT "FK_6f3f31e2ffe2b550436d9740476"`,
    );
    await queryRunner.query(
      `ALTER TABLE "question_collection" DROP CONSTRAINT "FK_5eb835210f7d4e610f1eeb3b31b"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_ec4e57f4138e339fb111948a16f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" DROP CONSTRAINT "FK_ab02fb05fe2e9b1e6ebaead78ed"`,
    );
    await queryRunner.query(
      `ALTER TABLE "chapter" DROP CONSTRAINT "FK_cac7772512e16a8cbbeea5a91ca"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3321e25af675736554263e6260"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_71d5a245ea8a708c1cc303bf0a"`,
    );
    await queryRunner.query(`DROP TABLE "program_subject"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6f3f31e2ffe2b550436d974047"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5eb835210f7d4e610f1eeb3b31"`,
    );
