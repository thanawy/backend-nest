...
export class ExtractChoiceToSeparateTable implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "question" DROP COLUMN "correct_answer"`);
        ...
        await queryRunner.query(`ALTER TABLE "question" ALTER COLUMN "chapter_id" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "password" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "choice" ADD CONSTRAINT "FK_d8ff1fcd448c6843621f423d077" FOREIGN KEY ("question_id") REFERENCES "question"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "answer" ADD CONSTRAINT "FK_3fd948de88641ecef00b348a16d" FOREIGN KEY ("choice_id") REFERENCES "choice"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "question" DROP CONSTRAINT "FK_749885cb1ae5482f4a25e978baa"`);
        await queryRunner.query(`ALTER TABLE "answer" DROP CONSTRAINT "FK_3fd948de88641ecef00b348a16d"`);
        await queryRunner.query(`ALTER TABLE "choice" DROP CONSTRAINT "FK_d8ff1fcd448c6843621f423d077"`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "password" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "question" ALTER COLUMN "chapter_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "question" ADD CONSTRAINT "FK_749885cb1ae5482f4a25e978baa" FOREIGN KEY ("chapter_id") REFERENCES "chapter"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "question" ADD "correct_answer" "public"."answer_enum" NOT NULL`);
        await queryRunner.query(`ALTER TABLE "question" ADD "answer_d" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "question" ADD "answer_c" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "question" ADD "answer_b" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "question" ADD "answer_a" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "answer" ADD "chapter_id" uuid`);
        await queryRunner.query(`ALTER TABLE "answer" ADD "chosen_answer" "public"."answer_enum" NOT NULL`);
